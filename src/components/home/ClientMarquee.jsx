...
const clients = [
  {
    name: 'PepsiCo',
    logo: 'https://media.base44.com/images/public/69e6c4bd9bbd15c86a9a4b38/7c2ebee46_image.png',
    scale: 2,
  },
  {
    name: 'Transcore',
...
export default function ClientMarquee() {
  return (
    <div className="border-t border-b border-border py-6 overflow-hidden bg-white">
      <p className="text-xs uppercase tracking-widest text-center text-neutral-500 mb-6 font-body px-6">
